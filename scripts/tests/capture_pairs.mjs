...
const SHOTS = [
  ...
  ['O1-chips-editorial-dark', '#/city/berlin', 'editorial', 'dark', 1440, 900, null,
    'the caution chip beside the two good-news chips, where they used to be identical'],
  ['O1-chips-warm-dark', '#/city/berlin', 'warm', 'dark', 1440, 900, null,
    'the same, in the other theme where warn was byte-identical to accent'],
  ['O1-chips-editorial-light', '#/city/berlin', 'editorial', 'light', 1440, 900, null,
    'and where only the WASH was identical'],
  ['O1-logo-warm-dark', '#/', 'warm', 'dark', 1440, 900, null,
    'the header compass dot, a conic gradient of accent and warn'],
  ['J10-map-caveat', '#/openings?view=map', 'compass', 'light', 1440, 1400, null,
    'the map own "not drawn" limit, written as a clause inside a 340-char paragraph'],
